...
int main(void)
{
  ...
  Lcd_cursor(&lcd,0,4);
  Lcd_string(&lcd,"212223040040");
  Lcd_cursor(&lcd,1,4);
  Lcd_string(&lcd,"Dhinesh M");
  while (1)
  {
    /* USER CODE END WHILE */
...
<img width="2336" height="1824" alt="1000332151" src="https://github.com/user-attachments/assets/7c10a833-4790-4bb2-829e-e31f104b08ec" />
